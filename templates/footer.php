            ...
            <div class="sj-footercolumns">
                <div class="col-12 col-sm-6 col-md-6 col-lg-3 float-left">
                    <div class="sj-fcol sj-footeraboutus">
                        <strong class="sj-logo">
                            <a href="index.php"><img src="assets/img/logo.png" alt="image description"></a>
                        </strong>
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-3 float-left">
                    <div class="sj-fcol sj-widget sj-widgetcontactus">
                        ...
                        <div class="sj-widgetcontent">
                            <ul>
                                <li><i class="lnr lnr-home"></i><address>Tagudin, Ilocos Sur 2714 </address></li>
                                <li><a href="tel:(077)6522093"><i class="lnr lnr-phone"></i><span>(077)652-2093</span></a></li>
                                <li><a href="mailto:ispsctagudin@yahoo.com"><i class="lnr lnr-envelope"></i><span>ispsctagudin@yahoo.com</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
